...
def draw_scatterplot(
    data, x_columns, y_column, hue_column=None, figsize=(8, 6), figshape=None
):
    """
...
def draw_histplot(
    data, columns, hue_column=None, figsize=None, figshape=None, kde=True
):
    """
...
def draw_countplot(
    data, columns, hue_column=None, figsize=None, figshape=None, annotation=True
):
    """
